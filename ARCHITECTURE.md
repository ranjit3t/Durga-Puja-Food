...
- **Screens**: Discrete full-page views.
    ...
    - `ActivityLogScreen`: Discrete historical audit view for administrators. Displays system-wide operations including high-fidelity error logs with **Stack Trace** expansion. Works as a live dashboard with 10s auto-refresh and heartbeat indicator. Supports forensic description search, multi-dimensional filtering, and data export.
