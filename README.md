...
- **Subscription-Aware Configuration Safety**: Critical settings are protected by real-time data validation. The system blocks switching off global "Kids Support", "Payment Integration", or individual "Festival Days" and "Meal Slots" if any existing subscription depends on them. This ensures data integrity and prevents orphaning active registrations.
